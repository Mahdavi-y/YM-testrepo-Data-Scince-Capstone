 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "    if entered_site == 'ALL':\n",
    "        new_df = filtered_df.groupby(['Launch Site']).count()\n",
    "        fig = px.pie(new_df, values='class', \n",
    "        names=new_df.index.values, \n",
    "        title='Total Success Launches By Site')\n",
    "        return fig\n",
    "    else:\n",
    "        new_df = filtered_df[filtered_df['Launch Site']==entered_site]\n",
    "        fig = px.pie(new_df.groupby(['class'])['class'].count().reset_index(name='class_count'), values='class_count', \n",
    "        names='class', \n",
    "        title= str('Total Success Launches for ' + entered_site))\n",
    "        return fig\n",
    "        \n",
    "    \n",
    "# TASK 4:\n",
    ...
    "        title= str('Correlation between Payload and Success for ' + entered_site))\n",
    "        return fig\n",
    "\n",
    "\n",
    "# Run the app\n",
